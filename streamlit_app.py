...
st.title("Classipet")
st.write("Clasificador de mascotas. Introduzca los datos de su mascotas y le diremos a que clase pertenece.")

st.image("img/mascotas.jpg", use_container_width=True)

# Carga del moelo entrenado ylas asignaciones para el color de ojos y el largo del pelo
...
weight = st.number_input("Peso en (kg)", min_value=0.0, max_value=100.0, value=0.0)
...
# Mapea la sellección de color de ojos y largo del pelo al español
